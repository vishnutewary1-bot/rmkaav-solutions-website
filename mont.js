/* =============================================================
   RMKAAV — mont-fort preview (mont.js)
   Scoped to mont.html. Does not touch the live site.
   Libraries expected on window: Lenis, gsap, ScrollTrigger.
   ============================================================= */
...
(function () {
    ...
    function initScene3D() {
        ...
        // Textures (via jsDelivr — cached after first load)
